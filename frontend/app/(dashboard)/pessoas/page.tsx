...
export default function PessoasPage() {
  ...
  const personsResponse = personsQuery.data as getApiPersonResponseSuccess | undefined;
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-foreground">Pessoas</h1>
          <p className="mt-1 text-sm text-muted-foreground">Gerencie os clientes cadastrados.</p>
        </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {searchQuery && (
          <Button variant="ghost" size="sm" onClick={() => setSearchQuery("")} className="gap-1.5">
            <X className="h-4 w-4" />
            Limpar
          </Button>
        )}
      ...
      <div className="text-sm text-muted-foreground">
        ...
        {filteredPersons.length === 1 ? "pessoa encontrada" : "pessoas encontradas"}
      </div>
